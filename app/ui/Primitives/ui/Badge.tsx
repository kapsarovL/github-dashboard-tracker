  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-success-bg text-success hover:opacity-80",
        warning:
          "border-transparent bg-warning-bg text-warning hover:opacity-80",
        info:
          "border-transparent bg-info-bg text-info hover:opacity-80",
      },
    },
    defaultVariants: {
      variant: "default",
